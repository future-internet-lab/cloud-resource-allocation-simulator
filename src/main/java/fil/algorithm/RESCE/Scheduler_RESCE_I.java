...
public class Scheduler_RESCE_I {
...
//			listPowerWarm.add(powerWarm1h/THOUS);
		...
		try {
			String path = "./PlotRESCE/Ideal/" + type;
			write_integer(path + "/UsedSerRESCEI.txt",listUsedSer);
			write_integer(path + "/ReqTWRESCEI.txt",listReqTW);
			write_integer(path + "/ReqLvTWRESCEI.txt",listReqLvTW);
			write_integer(path + "/ReqActiveRESCEI.txt",listSFCActive);
			write_integer(path + "/AcceptTWRESCEI.txt",listAcceptTW);
			write_integer(path + "/ErrorRESCEI.txt",listError);
			write_integer(path + "/RelocateRESCEI.txt",listRelocate);
			write_double(path + "/ServerUtilRESCEI.txt",listAveSerUtil);
			write_double(path + "/PowerRESCEI.txt",listPower);
			write_double(path + "/PowerColdTermRESCEI.txt",listPowerColdTerm);
			write_double(path + "/PowerWarmRESCEI.txt",listPowerWarm);
			write_double(path + "/EnergyRESCEI.txt",listEnergy);
			write_double(path + "/AveAcceptanceRESCEI.txt",listAcceptance);
			write_double(path + "/AveDownTimeRESCEI.txt",listDownTime);
