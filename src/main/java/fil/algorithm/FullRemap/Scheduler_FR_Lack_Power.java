...
public class Scheduler_FR_Lack_Power {
	...
	final static double INIENERGY = 0.0; // calculate by power*time/number of pod
	final static double DELENERGY = 0.0; // calculate by power*time/number of pod
...
//	private LinkedList<Service> poolReceive;
	...
	public Scheduler_FR_Lack_Power()  {
		topo = new Topology();
		fatTree = new FatTree();
...
//			listPowerWarm.add(powerWarm1h/THOUS);
		...
		try {
			String path = "./PlotRESCE-LP/" + type;
			write_integer(path + "/UsedSerRESCE-LP.txt",listUsedSer);
			write_integer(path + "/ReqTWRESCE-LP.txt",listReqTW);
			write_integer(path + "/ReqLvTWRESCE-LP.txt",listReqLvTW);
			write_integer(path + "/ReqActiveRESCE-LP.txt",listSFCActive);
			write_integer(path + "/AcceptTWRESCE-LP.txt",listAcceptTW);
			write_integer(path + "/ErrorRESCE-LP.txt",listError);
			write_integer(path + "/RelocateRESCE-LP.txt",listRelocate);
			write_double(path + "/ServerUtilRESCE-LP.txt",listAveSerUtil);
			write_double(path + "/PowerRESCE-LP.txt",listPower);
			write_double(path + "/PowerColdTermRESCE-LP.txt",listPowerColdTerm);
			write_double(path + "/PowerWarmRESCE-LP.txt",listPowerWarm);
			write_double(path + "/EnergyRESCE-LP.txt",listEnergy);
			write_double(path + "/AveAcceptanceRESCE-LP.txt",listAcceptance);
			write_double(path + "/AveDownTimeRESCE-LP.txt",listDownTime);
