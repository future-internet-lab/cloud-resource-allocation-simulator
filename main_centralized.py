...
def main_centralized(randomSeed, appArgs, runtime, argument, selector):
...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        for randomSeed in range(1,5):
            main_centralized(randomSeed, appArgs, runtime, [1], WaxmanSelector())
            # main_centralized(randomSeed, appArgs, runtime, [2,"d"], WaxmanSelector())
            main_centralized(randomSeed, appArgs, runtime, [1], VNFG())
            main_centralized(randomSeed, appArgs, runtime, [1], ONP_SFO(30))
            main_centralized(randomSeed, appArgs, runtime, [1], ONP_SFO(50))
        LAMDA += 1